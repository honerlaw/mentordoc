...
func (repo *DocumentContentRepository) Insert(content *model.DocumentContent) error {
...
func (repo *DocumentContentRepository) Update(document *model.DocumentContent) error {
